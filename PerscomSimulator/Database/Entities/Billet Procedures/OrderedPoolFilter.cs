...
{
    [Table]
    public class OrderedPoolFilter : AbstractFilter, IEquatable<OrderedPoolFilter>
    {
        #region Columns
        ...
        /// <summary>
        /// Gets the <see cref="OrderedPool"/> entity that this entity references.
        /// </summary>
        [InverseKey("Id")]
        ...
        /// <summary>
        /// Compares a <see cref="OrderedPoolFilter"/> with this one, and returns whether
        /// the identifying properties match
        /// </summary>
        /// <param name="other"></param>
        /// <returns></returns>
        public bool IsDuplicateOf(OrderedPoolFilter other)
        {
        ...
        public bool Equals(OrderedPoolFilter other)
        {
