...
namespace Perscom
{
    public partial class ExperienceFilterForm : Form
    {
        private BilletExperienceFilter Selected { get; set; }

        public ExperienceFilterForm(BilletExperienceFilter filter)
        {
            InitializeComponent();
            ...
            // Set indexies
            numericUpDown1.SetValueInRange(filter.Value);
        }
